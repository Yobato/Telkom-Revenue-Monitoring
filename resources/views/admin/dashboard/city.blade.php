                    ...
                    <form class="form-validation" id="cityForm" action="{{route('admin.storeCity')}}" method="POST">
                      ...
                      <div class="modal-body">
                        <div class="form-group">
                          ...
                          <span class="error-message" id="nama_city_error" style="display: none; color: red;">Field Nama
                            Kota harus diisi!</span>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a class="btn btn-sm btn-success btn-sm rounded-0" data-toggle="modal"
                          data-target="#editCityModal-{{$admins->id}}" style="color: white"><i
                            class="fa fa-edit"></i></a>

                        {{-- MODAL CITY --}}
                        <div class="modal fade" tabindex="-1" role="dialog" id="editCityModal-{{$admins->id}}"
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <form id="cityUpdateForm" class="form-validation"
                                action="{{route('admin.updateCity', [$admins->id])}}" method="POST">
                                @csrf
                                <div class="modal-body">
                                  <div class="form-group">
                                    <label for="nama_update_city" class="col-form-label">Nama Kota: </label>
                                    <input type="text" id="nama_update_city" name="nama_city" class="form-control"
                                      value="{{ $admins->nama_city }}" required>
                                    {{-- <span id="nama_city_error" class="error-message">Field Nama Kota harus
                                      diisi!</span> --}}
                                  </div>
                                </div>
                                <div class="modal-footer bg-whitesmoke br">
                                  <button type="button" class="btn btn-secondary" data-dismiss="modal"
                                    id="closeUpdateCity">Tutup</button>
                                  <button type="submit" class="btn btn-primary" value="Simpan Data">Simpan</button>
                                </div>
                              </form>
                            </div>
                        ...
                        <a class="btn btn-sm btn-danger btn-sm rounded-0" style="color: white" data-toggle="modal"
                          data-target="#deleteCityModal{{ $admins->id }}"><i class="fa fa-trash"></i></a>

                        {{-- MODAL DELETE --}}
                        <div class="modal fade" tabindex="-1" role="dialog" id="deleteCityModal{{ $admins->id }}"
                          data-backdrop="static">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                              ...
                              <div class="modal-footer bg-whitesmoke br">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal"
                                  id="closeCity2">Batal</button>
                                <a class="btn btn-danger" href="{{ route('admin.deleteCity', [$admins->id]) }}"
