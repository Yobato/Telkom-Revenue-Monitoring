              ...
              <div class="card-header">
                ...
                <div class="col-4 d-flex justify-content-end">
                  <button type="button" class="btn btn-primary" data-toggle="modal"
                    data-target="#accountAddModal">Tambah Account</button>
                </div>
              </div>
              ...
              <div class="modal fade" tabindex="-1" role="dialog" id="accountAddModal" data-backdrop="static">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <form class="form-validation" id="accountForm" action="{{route('admin.storeAccount')}}"
                      method="POST">
                      @csrf
                      <div class="modal-body">
                        <div class="form-group">
                          ...
                          <span class="error-message" id="nama" style="display: none; color: red;">Field Nama harus
                            diisi!</span>

                          <label for="nik" class="col-form-label">NIK: </label>
                          <input type="text" id="nik" name="nik" class="required-input form-control">
                          <span class="error-message" id="nik" style="display: none; color: red;">Field NIK harus
                            diisi!</span>

                          <label for="password" class="col-form-label">Password: </label>
                          <input type="password" id="password" name="password" class="required-input form-control">
                          <span class="error-message" id="password_error" style="display: none; color: red;">Field
                          ...
                          <span class="error-message" id="kota_error" style="display: none; color: red;">Field Kota
                            harus diisi!</span>

                          <label for="keterangan" class="col-form-label">Keterangan: </label>
                          <input type="text" id="keterangan" name="keterangan" class="required-input form-control">
                          {{-- <textarea id="keterangan" name="keterangan" class="form-control" rows="10"
                            cols="500"></textarea> --}}
                          <span class="error-message" id="keterangan_error" style="display: none; color: red;">Field
                            Keterangan harus diisi!</span>
                        </div>
                      </div>
                      <div class="modal-footer bg-whitesmoke br">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal"
                          id="closeAccount2">Tutup</button>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a class="btn btn-sm btn-success btn-sm rounded-0" data-toggle="modal"
                          data-target="#editAccountModal-{{$admins->id}}" style="color: white"><i
                            class="fa fa-edit"></i></a>

                        {{-- MODAL EDIT --}}
                        <div class="modal fade" tabindex="-1" role="dialog" id="editAccountModal-{{$admins->id}}"
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <form id="accountUpdateForm" class="form-validation"
                                action="{{route('admin.updateAccount', [$admins->id])}}" method="POST">
                                @csrf
                                <div class="modal-body">
                                  <div class="form-group">
                                    <label for="nama" class="col-form-label">Nama: </label>
                                    ...
                                    <input type="text" id="nik" name="nik" class="form-control"
                                      value="{{ $admins->nik }}" required>
                                    <span id="nik" style="display: none; color: red;">Field NIK harus diisi!</span>

                                    <label for="password" class="col-form-label">Password: </label>
                                    <input type="password" id="password" name="password" class="form-control"
                                      placeholder="Kosong">
                                    <span id="password_error" style="display: none; color: red;">Field Password harus
                                      diisi!</span>
                                    ...
                                    <select class="kota form-control" name="kota" required>
                                      <option value="{{$admins->kota}}" onclick="pushData('kota')" selected>
                                        {{$citys[$admins->kota]}}</option>
                                      @foreach ($addcity as $city)
                                    ...
                                    <span id="kota_error" style="display: none; color: red;">Field Kota harus
                                      diisi!</span>

                                    <label for="keterangan" class="col-form-label">Keterangan: </label>
                                    <input type="text" id="keterangan" name="keterangan" class="form-control"
                                      value="{{ $admins->keterangan }}" required>
                                    {{-- <textarea id="keterangan" name="keterangan" class="form-control" rows="10"
                                      cols="500"></textarea> --}}
                                    <span id="keterangan_error" style="display: none; color: red;">Field Keterangan
                                      harus diisi!</span>
                                  </div>
                                </div>
                                <div class="modal-footer bg-whitesmoke br">
                                  <button type="button" class="btn btn-secondary" data-dismiss="modal"
                                    id="closeUpdateAccount">Tutup</button>
                                  <button type="submit" class="btn btn-primary" value="Simpan Data">Simpan</button>
                                </div>
                              </form>
                            </div>
                        ...
                        <a class="btn btn-sm btn-danger btn-sm rounded-0" style="color: white" data-toggle="modal"
                          data-target="#deleteAccountModal{{ $admins->id }}"><i class="fa fa-trash"></i></a>

                        {{-- MODAL DELETE --}}
                        <div class="modal fade" tabindex="-1" role="dialog" id="deleteAccountModal{{ $admins->id }}"
                          data-backdrop="static">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                              ...
                              <div class="modal-footer bg-whitesmoke br">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal"
                                  id="closeAccount2">Batal</button>
                                <a class="btn btn-danger" href="{{ route('admin.deleteAccount', [$admins->id]) }}"
