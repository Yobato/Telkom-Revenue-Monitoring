              ...
              <div class="card-header">
                ...
                <div class="col-4 d-flex justify-content-end">
                  <button type="button" class="btn btn-primary" data-toggle="modal"
                    data-target="#programAddModal">Tambah Program</button>
                </div>
              </div>
              ...
              <div class="modal fade" tabindex="-1" role="dialog" id="programAddModal" data-backdrop="static">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <form class="form-validation" id="programForm" action="{{route('admin.storeProgram')}}"
                      method="POST">
                      @csrf
                      <div class="modal-body">
                        <div class="form-group">
                          ...
                          <span class="error-message" id="error_nama_program" style="display: none; color: red;">Field
                            Nama Program harus diisi!</span>
                          ...
                          <span class="error-message" id="error_kode_program" style="display: none; color: red;">Field
                            Kode Program harus diisi!</span>

                          <label for="role" class="col-form-label">Role: </label>
                          <select class="required-input role form-control" id="roless" name="role"
                            onchange="getPorto()">
                          ...
                          <span class="error-message" id="role_error" style="display: none; color: red;">Field Role
                            harus diisi!</span>

                          <label for="ketentuan" class="col-form-label">Apakah program harus sesuai portofolio: </label>
                          <select id="ketentuan"
                            class="ketentuan form-control @error('ketentuan') is-invalid @enderror mb-2"
                            name="ketentuan">
                          ...
                          <span class="error-message" id="ketentuan_error" style="display: none; color: red;">Field ini
                            harus diisi!</span>
                ...
                <table class="table" id="table-1">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        {{-- UPDATE PROGRAM --}}
                        <a class="btn btn-sm btn-success btn-sm rounded-0" data-toggle="modal"
                          data-target="#editProgramModal-{{$admins->id}}" style="color: white"><i
                            class="fa fa-edit"></i></a>

                        {{-- MODAL EDIT --}}
                        <div class="modal fade" tabindex="-1" role="dialog" id="editProgramModal-{{$admins->id}}"
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <form id="programUpdateForm" class="form-validation"
                                action="{{route('admin.updateProgram', [$admins->id])}}" method="POST">
                                @csrf
                                <div class="modal-body">
                                  <div class="form-group">
                                    <label for="nama_program" class="col-form-label">Nama Program: </label>
                                    <input type="text" id="nama_program_update" name="nama_program" class="form-control"
                                      value="{{ $admins->nama_program }}" required>
                                    <span id="nama_program_update_error" style="display: none; color: red;">Field Nama
                                      harus diisi!</span>

                                    <label for="kode" class="col-form-label">Kode Program: </label>
                                    <input type="text" id="kode_program_update" name="kode_program" class="form-control"
                                      value="{{ $admins->kode_program }}" required>
                                    <span class="error-message" id="error_kode_program_update"
                                      style="display: none; color: red;">Field Kode Program harus diisi!</span>
                                    ...
                                    <span id="role_error" style="display: none; color: red;">Field Role harus
                                      diisi!</span>

                                    <label for="id_portofolio_edit" class="col-form-label">Portofolio: </label>
                                    <select class="id_portofolio_edit form-control" name="id_portofolio"
                                      id="id_portofolio_edit">
                                      <option value="" {{ $admins->id_portofolio == "" ? 'selected' : '' }}>-- Pilih
                                        Portofolio --</option>
                                      @foreach ($portofolios as $portofolio)
                                      @if ($admins->id_portofolio !== "")
                                      <option value="{{ $portofolio->id }}" {{ $admins->id_portofolio == $portofolio->id
                                        ? 'selected' : '' }}>
                                ...
                                <div class="modal-footer bg-whitesmoke br">
                                  <button type="button" class="btn btn-secondary" data-dismiss="modal"
                                    id="closeUpdateProgram">Tutup</button>
                                  <button type="submit" class="btn btn-primary" value="Simpan Data">Simpan</button>
                                </div>
                              </form>
                            </div>
                        ...
                        {{-- DELETE PROGRAM --}}
                        <a class="btn btn-sm btn-danger btn-sm rounded-0" style="color: white" data-toggle="modal"
                          data-target="#deleteProgramModal{{ $admins->id }}"><i class="fa fa-trash"></i></a>

                        {{-- MODAL DELETE --}}
                        <div class="modal fade" tabindex="-1" role="dialog" id="deleteProgramModal{{ $admins->id }}"
                          data-backdrop="static">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                              ...
                              <div class="modal-footer bg-whitesmoke br">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal"
                                  id="closeProgram2">Batal</button>
                                <a class="btn btn-danger" href="{{ route('admin.deleteProgram', [$admins->id]) }}"
