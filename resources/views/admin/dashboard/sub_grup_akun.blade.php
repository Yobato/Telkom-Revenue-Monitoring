    ...
    <section class="section">
      ...
      <div class="section-body">
        ...
        <p class="section-lead">
          Kelola Sub Grup Akun pada sistem. Sub Grup Akun disini akan memengaruhi interaksi Anda pada sistem seperti
          filter dan search!
        </p>
                    ...
                    <form class="form-validation" id="subForm" action="{{route('admin.storeSub')}}" method="POST">
                      ...
                      <div class="modal-body">
                        <div class="form-group">
                          ...
                          <span class="error-message" id="nama_sub_error" style="display: none; color: red;">Field Nama
                            Sub Grup Akun harus diisi!</span>
                      ...
                      <div class="modal-footer bg-whitesmoke br">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal"
                          id="closeSubGrupAkun2">Tutup</button>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a class="btn btn-sm btn-success btn-sm rounded-0" data-toggle="modal"
                          data-target="#editSubModal-{{$admins->id}}" style="color: white"><i
                            class="fa fa-edit"></i></a>

                        {{-- MODAL EDIT --}}
                        <div class="modal fade" tabindex="-1" role="dialog" id="editSubModal-{{$admins->id}}"
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <form id="subUpdateForm" class="form-validation"
                                action="{{route('admin.updateSub', [$admins->id])}}" method="POST">
                                @csrf
                                <div class="modal-body">
                                  <div class="form-group">
                                    <label for="nama_update_sub" class="col-form-label">Nama Sub Grup Akun: </label>
                                    <input type="text" id="nama_update_sub" name="nama_sub" class="form-control"
                                      value="{{ $admins->nama_sub }}" required>
                                    {{-- <span id="nama_sub_error" class="error-message">Field Nama Sub Grup Akun harus
                                      diisi!</span> --}}
                                  </div>
                                </div>
                                <div class="modal-footer bg-whitesmoke br">
                                  <button type="button" class="btn btn-secondary" data-dismiss="modal"
                                    id="closeUpdateSub">Tutup</button>
                                  <button type="submit" class="btn btn-primary" value="Simpan Data">Simpan</button>
                                </div>
                              </form>
                            </div>
                        ...
                        <a class="btn btn-sm btn-danger btn-sm rounded-0" style="color: white" data-toggle="modal"
                          data-target="#deleteSubModal{{ $admins->id }}"><i class="fa fa-trash"></i></a>

                        <!-- MODAL DELETE -->
                        <div class="modal fade" tabindex="-1" role="dialog" id="deleteSubModal{{ $admins->id }}"
                          data-backdrop="static">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                              ...
                              <div class="modal-footer bg-whitesmoke br">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal"
                                  id="closeSub2">Batal</button>
                                <a class="btn btn-danger" href="{{ route('admin.deleteSub', [$admins->id]) }}"
