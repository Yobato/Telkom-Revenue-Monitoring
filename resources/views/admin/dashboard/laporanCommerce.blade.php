                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href={{ route('admin.editableCommerce', [$admins->slug]) }} class="btn btn-primary btn-sm rounded-0" type="button">
                                                <i class="fa fa-edit"></i> Open Edit</a>
                                            @endif
                                            @if($admins->editable == 1)
                                            <a href={{ route('admin.uneditableCommerce', [$admins->slug]) }} class="btn btn-danger btn-sm rounded-0" type="button">
