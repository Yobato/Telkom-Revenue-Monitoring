<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li
                class="nav-item dropdown {{  $title ==='City'|| $title==='Cost Plan'|| $title==='Program'|| $title==='Portofolio'|| $title==='Peruntukan' || $title==='User Reco' || $title==='Role' || $title==='SubGrupAkun' ? 'active' : '' }}">
                <a href="#" class="nav-link has-dropdown"><i
                        class="bi bi-menu-button-fill"></i><span>Dropdown</span></a>
                <ul class="dropdown-menu">
                    <li class="{{ $title==='City' ? ' active' : '' }}">
                        <a class="nav-link" href="{{ route('admin.dashboard.city')}}">City</a>
                    </li>
                    <li class="{{ $title==='Cost Plan' ? ' active' : '' }}">
                        <a class="nav-link" href="{{ route('admin.dashboard.cost_plan')}}">Cost Plan</a>
                    </li>
                    <li class="{{ $title==='Program' ? ' active' : '' }}">
                        <a class="nav-link" href="{{ route('admin.dashboard.program')}}">Program</a>
                    </li>
                    <li class="{{ $title==='Portofolio' ? ' active' : '' }}">
                        <a class="nav-link" href="{{ route('admin.dashboard.portofolio')}}">Portofolio</a>
                    </li>
                    <li class="{{ $title==='Peruntukan' ? ' active' : '' }}">
                        <a class="nav-link" href="{{ route('admin.dashboard.peruntukan')}}">Peruntukan</a>
                    </li>
                    <li class='{{ $title==='Role' ? ' active' : '' }}'>
                        <a class="nav-link" href="{{ route('admin.dashboard.role')}}">Role</a>
                    </li>
                    <li class='{{ $title==='SubGrupAkun' ? ' active' : '' }}'>
                        <a class="nav-link" href="{{ route('admin.dashboard.sub')}}">Sub Grup Akun</a>
                    </li>
                    <li class="{{ $title==='User Reco' ? ' active' : '' }}">
                        <a class="nav-link" href="{{ route('admin.dashboard.user_reco')}}">User Laporan</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="{{ $title==='Account' ? ' active' : '' }}"><a class="nav-link"
                    href="{{route('admin.dashboard.account')}}"><i class="bi bi-people-fill"></i><span>Manajemen
                        Pengguna</span></a></li>
            {{-- <li class="{{ $title==='Target' || $title==='Laporan Commerce' ? ' active' : '' }}"><a class="nav-link"
                    href="{{route('admin.dashboard.target')}}"><span>Manajemen Target</span></a></li> --}}
        </ul>
    </aside>
</div>