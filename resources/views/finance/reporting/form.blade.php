...
<section class="section">
                ...
                <div class="card">
                    ...
                    <div class="card-body d-flex justify-content-start" style="padding-bottom:0; margin-bottom:0;">
                        <div class="breadcrumb-item"><a href="{{ route('finance.dashboard.index') }}">KKP
                                Operasional</a></div>
                        <div class="breadcrumb-item active">Create PID Finance </div>
                    </div>
                    ...
                    <p style="padding-left: 43px; padding-bottom:10px">Create a Finance PID in accordance with the provisions and SOPs that apply at Telkom Access. You can change this Finance
                    PID later.</p>
                </div>
            </div>
        </div>
    ...
    <div class="section-body">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="px-5 pt-4" style="font-size: 140%"><b>Create PID Finance</b></div>
                    <div class="px-5 pt-2 pb-0">Adjust the data needed to create a Finance PID</div>
                    <form action="{{route('finance.storeLaporanFinance')}}" method="POST">
                        ...
                        <div class="d-flex justify-content-end pr-5 mb-5">
                            <button class="btn btn-primary" value="Simpan Data" type="submit">Create PID Finance</button>
                        </div>
                    </form>
                </div>
            </div>
