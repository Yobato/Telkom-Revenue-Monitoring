...
<section class="section">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body d-flex justify-content-start" style="padding-bottom:0; margin-bottom:0;">
                        <div class="breadcrumb-item"><a href="{{ route('commerce.dashboard.index') }}">Laporan
                                Commerce</a></div>
                        <div class="breadcrumb-item active">Edit Report</div>
                    </div>
    ...
    <div class="section-body">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="px-5 pt-4" style="font-size: 140%"><b>Edit Report</b></div>
                    <div class="px-5 pt-2 pb-0">Adjust the data needed to edit report</div>
                    ...
                    <form action="{{route('commerce.updateLaporanCommerce', [$id])}}" method="POST">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group pt-4 pb-0 pl-5 mb-0 pb-0">
                                    ...
                                    <input type="text" id="id_commerce" name="id_commerce"
                                        ...
                                        value="{{ old('id_commerce', $laporan->id_commerce) }}" readonly>
                                    @error('id_commerce')
                                    ...
                                    <select
                                        ...
                                        name="id_program" value="{{ old('id_program', $laporan->id_program) }}">
                                        <option value="" selected>-- Choose Program Name --</option>
                                        @foreach ($addprogram as $program)
                                        <option value="{{ $program->id }}" {{ old('id_program', $laporan->id_program) ==
                                            $program->id ? 'selected' : '' }}>{{ $program->nama_program }}</option>
                                        @endforeach
                                    </select>
                                    @error('id_program')
                                    <div class="invalid-feedback">
                                    ...
                                    <select
                                        ...
                                        name="id_portofolio"
                                        value="{{ old('id_portofolio', $laporan->id_portofolio) }}">
                                        <option value="" selected>-- Choose Portofolio --</option>
                                        @foreach ($addportofolio as $portofolio)
                                        <option value="{{ $portofolio->id }}" {{ old('id_portofolio', $laporan->
                                            id_portofolio) == $portofolio->id ? 'selected' : '' }}>{{
                            ...
                            <div class="col-lg-6">
                                <div class="form-group pt-4 pb-0 pr-5 mb-0">
                                    ...
                                    <select
                                        ...
                                        name="id_sub_grup_akun"
                                        value="{{ old('id_sub_grup_akun', $laporan->id_sub_grup_akun) }}">
                                        <option value="" selected>-- Choose Sub Grup Akun --</option>
                                        @foreach ($addsubgrupakun as $subgrupakun)
                                        <option value="{{ $subgrupakun->id }}" {{ old('id_sub_grup_akun', $laporan->
                                            id_sub_grup_akun) == $subgrupakun->id ? 'selected' : '' }}>{{
                                    ...
                                    <select
                                        ...
                                        name="jenis_laporan">
                                        <option value="COGS" {{ old('jenis_laporan', $laporan->jenis_laporan) === 'COGS'
                                            ? 'selected' : '' }}>COGS</option>
                                        <option value="REVENUE" {{ old('jenis_laporan', $laporan->jenis_laporan) ===
                                            'REVENUE' ? 'selected' : '' }}>REVENUE</option>
                                    </select>
                                    <span id="jenis_laporan_error" style="display: none; color: red;">Field Jenis
                                        Laporan harus diisi!</span>
                                    @error('jenis_laporan')
                                    <div class="invalid-feedback">
                        ...
                        <div class="d-flex justify-content-end pr-5 mb-5">
                            <button class="btn btn-primary" value="Simpan Data" type="submit">Edit Report</button>
                        </div>
                    </form>
                    @endforeach
                </div>
