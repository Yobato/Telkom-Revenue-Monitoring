        ...
        <div class="row">
            <div class="col-12 col-sm-12 ">
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <div class="filter d-flex ">
                                ...
                                <select class="form-control" name="portofolio-filter-cogs-1"
                                    id="portofolio-filter-cogs-1" style="border-radius: 8px">
                                ...
                                <select class="form-control" name="portofolio-filter-cogs-2"
                                    id="portofolio-filter-cogs-2" style="border-radius: 8px">
                                    @foreach ($filterPortofolio as $porto)
                                    <option value=<?=$porto->id ?>>{{ $porto->nama_portofolio }}</option>
                                    @endforeach
                                </select>
                                <label for="portofolio-3" class="col-form-label ml-3 mr-3">Portofolio </label>
                                <select class="form-control" name="portofolio-filter-cogs-3"
                                    id="portofolio-filter-cogs-3" style="border-radius: 8px">
                                    @foreach ($filterPortofolio as $porto)
                                    <option value=<?=$porto->id ?>>{{ $porto->nama_portofolio }}</option>
                                    @endforeach
                                </select>
                                <label for="tahunPerbandingan" class="col-form-label ml-3 mr-3">Filter </label>
                                <select class="form-control" name="tahun-filter-perbandingan-porto" id="tahun-filter-perbandingan-porto" style="border-radius: 8px">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h4 style="color:#525358; font-weight:bold">Total COGS Operasional</h4>
                            <div class="filter d-flex ">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h4 style="color:#525358; font-weight:bold">COGS Operasional Portofolio</h4>
                        <div class="filter d-flex ">
...
<script>
    ...
    const totalCOGSData = {!! json_encode($totalCOGSData) !!};
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    let dropdownPortofolio1 = document.getElementById("portofolio-filter-cogs-1");
    let selectedValuePorto1 = dropdownPortofolio1.value;
    let dropdownPortofolio2 = document.getElementById("portofolio-filter-cogs-2");
    let selectedValuePorto2 = dropdownPortofolio2.value;
    let dropdownPortofolio3 = document.getElementById("portofolio-filter-cogs-3");
    ...
    function updateChartPorto(valuePorto1,   valuePorto2, valuePorto3, valueYear) {
        if (valuePorto1 !== "" || valuePorto2 !== "" || valuePorto3 !== "") {
            ...
            const filteredCOGSDataByPorto1 = filteredCOGSData.filter(item => item.id_portofolio === Number(valuePorto1));
            const filteredCOGSDataByPorto2 = filteredCOGSData.filter(item => item.id_portofolio === Number(valuePorto2));
            const filteredCOGSDataByPorto3 = filteredCOGSData.filter(item => item.id_portofolio === Number(valuePorto3));
            const seriesDataPerbandingan1 = {};
            const seriesDataPerbandingan2 = {};
            const seriesDataPerbandingan3 = {};
            const filteredDataByPorto1 = filteredCOGSDataByPorto1.filter(item => item.id_portofolio === Number(valuePorto1));
            const filteredDataByPorto2 = filteredCOGSDataByPorto2.filter(item => item.id_portofolio === Number(valuePorto2));
            const filteredDataByPorto3 = filteredCOGSDataByPorto3.filter(item => item.id_portofolio === Number(valuePorto3));
            ...
            Highcharts.chart('chartCOGSPorto', {
                // ... pengaturan chart
                chart: {
                    type: 'line'
                },
    ...
    function updateChartTotal(valueYear) {
        const filteredCOGSData = totalCOGSData.filter(item => item.year.toString() === valueYear);
        ...
        Highcharts.chart('chartCOGSTotal', {
            // ... pengaturan chart
            chart: {
                type: 'line'
            },
