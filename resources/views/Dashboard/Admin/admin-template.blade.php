...
<head>
  ...
  <title>Dashboard - Telkom Revenue Monitoring</title>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">TelkomAkses</span>
      </a>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2">S. Patrick</span>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-bar-chart-fill"></i><span>Dashboard</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="#">
              <i class="bi bi-circle"></i><span>Gross Profit Margin</span>
            </a>
          </li>
          <li>
            <a href="#">
              <i class="bi bi-circle"></i><span>Cost of Goods Sold</span>
            </a>
          </li>
          <li>
            <a href="#">
          ...
          <li>
            <a href="#">
              <i class="bi bi-circle"></i><span>KKP Operasional</span>
            </a>
          </li>
        </ul>
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="#">
              <i class="bi bi-circle"></i><span>Commerce</span>
            </a>
          </li>
          <li>
            <a href="#">
          ...
          <li>
            <a href="#">
              <i class="bi bi-circle"></i><span>General Manager</span>
            </a>
          </li>
        </ul>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-ui-checks"></i><span>Target Management</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
      ...
      </li><!-- End Target Management Nav -->

      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-pie-chart-fill"></i><span>Reporting</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="charts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="#">
              <i class="bi bi-circle"></i><span>COGS & Revenue</span>
            </a>
          </li>
          <li>
            <a href="#">
